...
import sty from "./PlasmicModal.module.css"; // plasmic-import: QsGKyhsi7rjB/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_rwNru_8l9p22"]]: true })}
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__dVc4Z)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {$props.showFooter ? (
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__v1LxU)}
                    >
                      <Button2
                        color={"muted"}
                        label={
