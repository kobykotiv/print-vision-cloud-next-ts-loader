...
function PlasmicPortfolio__RenderFunc(props: {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    ...
    test: usePlasmicDataOp(() => {
      return {
        sourceId: "83X9ZdYzYUYJtgqe5fwXeX",
        opId: "ab2e0387-4e35-49ec-b544-2dd4da405557",
        userArgs: {},
        cacheKey: `plasmic.$.ab2e0387-4e35-49ec-b544-2dd4da405557.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    })
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
                      ...
                      rowActions: (() => {
                        ...
                        __composite["1"]["onClick"] = async (rowKey, row) => {
                          ...
                          if (
                            ...
                            typeof $steps["updateSelectedRow"].then ===
                              "function"
                          ) {
                          ...
                          if (
                            ...
                            typeof $steps["runActionOnForm4"].then ===
                              "function"
                          ) {
                        ...
                        __composite["2"]["onClick"] = async (rowKey, row) => {
                          ...
                          if (
                            ...
                            $steps["updateModalDeleteDesignOpen"] =
                              await $steps["updateModalDeleteDesignOpen"];
                          }
                        };
                        return __composite;
                      })(),
                  ...
                  >
                    ...
                    >
                      ...
                      {(_par =>
                        ...
                        (() => {
                          try {
                            return $queries.queryGetDesignsByUser.data;
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
                              e?.plasmicType === "PlasmicUndefinedDataError"
          ...
          >
            ...
            >
              {
                "There's no going back. This action Deletes this design and its contents."
              }
            </div>
          </AntdModal>
        </div>
