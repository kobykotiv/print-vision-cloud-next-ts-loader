...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: nXXUUxjRiMDQ/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: K-pKo-0OAxvA/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__cUf6S)}
                >
                  <div
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2__izkMy)}
            label={"Open Popover"}
          />
        ),
