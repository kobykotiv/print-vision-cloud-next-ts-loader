...
import Button from "../../Button"; // plasmic-import: 7ZC-La1jrz19/component
...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: XB84G94XjtOY/css

import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: OX8Wao-6hRIT/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: ifNHMDR6hmKo/icon
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__aEj8U)}
                >
                  {"Show dialog"}
                </Button>
              ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___7N6Xf)}
              >
                <div
                  className={classNames(
                    projectcss.all,
